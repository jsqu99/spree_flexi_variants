OrdersController.class_eval do
  ...
  # 
  # Currently, we are assuming the inbound ad_hoc_variant_option_values and customizations apply to the entire inbound product/variant 'group', as more surgery 
  ...
  def populate
    ...
    params[:products].each do |product_id,variant_id|
      ...
      @order.add_variant(Variant.find(variant_id), ad_hoc_variant_option_value_ids, product_customizations, quantity) if quantity > 0
  ...
  def ad_hoc_variant_option_value_ids # (variant_id)
    ids=[]
