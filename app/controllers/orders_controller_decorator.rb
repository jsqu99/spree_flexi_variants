OrdersController.class_eval do
  prepend_before_filter :find_or_create_dynamic_variant

  private
  def find_or_create_dynamic_variant
    return unless params[:dynamic_options].present?

    # return dynamic variant id based on params[:dynamic_options], :products, and :variant
    #
    # a dynamic variant has option values.  We will need to create new option values in the event of a customization
  end
end
