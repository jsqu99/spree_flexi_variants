...
class OptionPricingStrategy::AmountOptionPricingStrategy < OptionPricingStrategy
  ...
  # javascript will exist in a 'strategy-aware partial' to handle this hash
  def all_combinations
    # implement strategy here
    # {option_value_id: amount}
  end

  def compute(option_value, *other_option_values) # last arg is ignored by this strategy
